...
* With sencere apologies I must inform that this mod is no longer gonna be worked on. Feel free to fork it under CC-BY-SA-4.0 or any supported license.
...
Starting from version 2.0 of Hit Indication, versions other than 1.18.2, 1.16.5 and 1.12.2 will not be receiving any new updates for the sake of my mental health. Older versions are still available to download for currently unsupported Minecraft versions.
