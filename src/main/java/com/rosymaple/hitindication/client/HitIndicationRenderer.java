...
public class HitIndicationRenderer {
    private static final ResourceLocation INDICATOR = ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/indicator.png");
    private static final ResourceLocation EDGE_INDICATOR = ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/edge_indicator.png");
    private static final ResourceLocation INDICATOR_BLOCK = ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/indicator_block.png");
    private static final ResourceLocation ND_INDICATOR = ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/nd_person_damage.png");
    ...
    public static void render(GuiGraphics gui, DeltaTracker deltaTracker) {
        ...
        if (HitIndicatorClientConfigs.EdgeOfScreenMode.get()) {
            for (HitIndicator hit : ClientLatestHits.latestHitIndicators)
                drawIndicatorEdge(gui, hit, screenMiddleX, screenMiddleY, playerPos, lookVec);
        } else {
            for (HitIndicator hit : ClientLatestHits.latestHitIndicators)
