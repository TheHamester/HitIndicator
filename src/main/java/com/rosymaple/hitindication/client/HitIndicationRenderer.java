...
public class HitIndicationRenderer {
    private static final ResourceLocation INDICATOR_RED = ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/indicator_red.png");
    private static final ResourceLocation INDICATOR_BLUE = ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/indicator_blue.png");
    private static final ResourceLocation ND_RED_INDICATOR = ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/nd_person_damage.png");
    private static final ResourceLocation[] MARKER_CRIT = {
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_crit1.png"),
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_crit2.png"),
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_crit3.png"),
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_crit4.png")
    };

    private static final ResourceLocation[] MARKER_KILL = {
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_kill1.png"),
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_kill2.png"),
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_kill3.png"),
            ResourceLocation.fromNamespaceAndPath(HitIndication.MODID, "textures/hit/marker_kill4.png")
    };
    ...
    public static void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        int screenMiddleY = mc.getWindow().getGuiScaledHeight() / 2;
    ...
    private static void drawIndicator(GuiGraphics gui, HitIndicator hit, int screenMiddleX, int screenMiddleY, Vec2 playerPos, Vec2 lookVec) {
        ...
        gui.pose().translate(-screenMiddleX, -screenMiddleY, 0);
        gui.blit(atlasLocation, screenMiddleX - scaledTextureWidth / 2, screenMiddleY - scaledTextureHeight / 2 - (hit.getType() == HitIndicatorType.ND_RED ? 0 : distanceFromCrosshair), 0, 0, scaledTextureWidth, scaledTextureHeight, scaledTextureWidth, scaledTextureHeight);
        RenderSystem.setShaderColor(1, 1, 1, 1);
        gui.pose().popPose();
    ...
    private static ResourceLocation getIndicatorTexture(HitIndicatorType type) {
        switch(type) {
            ...
            case ND_RED: return ND_RED_INDICATOR;
