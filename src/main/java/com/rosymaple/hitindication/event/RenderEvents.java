...
public class RenderEvents {
    ...
    private static final int markerSize = 20;
    ...
    private static void drawHitMarker(PoseStack stack, HitMarker hitMarker, int screenMiddleX, int screenMiddleY) {
        ...
        Gui.blit(stack, screenMiddleX - markerSize / 2, screenMiddleY - markerSize / 2 , 0, 0, markerSize, markerSize, markerSize, markerSize);
